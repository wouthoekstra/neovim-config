...
-- Exit terminal mode with Shift+Escape. Using <S-Esc> instead of the kickstart
-- default <Esc><Esc> to avoid a 300ms input delay in terminal buffers caused by
-- timeoutlen disambiguation (especially noticeable in Claude Code which uses
